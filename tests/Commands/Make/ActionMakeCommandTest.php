...
class ActionMakeCommandTest extends BaseTestCase
{
    ...
    public function test_it_generates_a_new_action_class_can_use_invoke_option()
    {
        ...
        $this->assertTrue(is_file(explode('modules/', $this->test_module_app_path('Actions/MyAction.php'))[1]));
        $this->assertSame(0, $code);
    }
    ...
    public function test_it_generated_correct_file_with_content()
    {
        ...
        $file = $this->files->get($this->test_module_app_path('Actions/MyAction.php'));
    ...
    public function test_it_can_generate_a_action_in_sub_namespace_in_correct_folder()
    {
        ...
        $this->assertTrue(is_file($this->test_module_app_path('Actions/Api/MyAction.php')));
        $this->assertSame(0, $code);
    }
    ...
    public function test_it_can_generate_a_action_in_sub_namespace_with_correct_generated_file()
    {
        ...
        $file = $this->files->get($this->test_module_app_path('Actions/Api/MyAction.php'));
